...
const settingsInput = {
  ...
  whatsapp: "",
  mapsUrl: "",
  aboutTitle: { tr: "Benzersiz bir deneyim" },
  aboutText: { tr: "" },
  whyUs1Title: { tr: "" },
  whyUs1Text: { tr: "" },
  whyUs2Title: { tr: "" },
...
const staffWrappers: [string, () => Promise<{ ok: boolean; error?: string }>][] = [
  ...
  ["upsertService", () => upsertService({ name: { tr: "Saç" }, durationMinutes: 30, priceLira: 400, sortOrder: 1 })],
  ...
  ["updateGalleryPhoto", () => updateGalleryPhoto("g1", { caption: { tr: "Fade" }, tags: "Fade" })],
